package net.thatsavagedev.tutorialmod;

import net.minecraft.world.item.CreativeModeTabs;
import net.thatsavagedev.tutorialmod.block.ModBlocks;
import net.thatsavagedev.tutorialmod.item.ModCreativeModeTabs;
...
public class TutorialMod {
    public static final String MOD_ID = "thatsavagekiwisblocksandstuff";
